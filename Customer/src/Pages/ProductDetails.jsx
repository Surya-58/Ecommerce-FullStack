    ...
    <div className="container">
      <div className="pdp">
        ...
        <div className="pdp-info">
          ...
          <p className="pdp-info__brand">{product.category}</p>
          ...
          <div className="pdp-info__actions">
            ...
            >
              {wishlistAdded ? "❤️ Remove from Wishlist" : "🤍 Add to Wishlist"}
            </button>
          </div>

          <div className="pdp-info__delivery">🚚 Delivery in 30-45 minutes</div>
        </div>
      </div>
